/*
 * This was mostly compiled by the creator of the Obsidian plugin "Latex suite", i just added a few of my own
 * very messy!
 */
...
[
  ...
  //my own
  { trigger: "nat", replacement: "\\mathbb{N}", options: "mA" },
  { trigger: "field", replacement: "\\mathbb{F}^{$0} $1", options: "mA" },
  { trigger: "real", replacement: "\\mathbb{R}^{$0} $1", options: "mA" },
  { trigger: "zah", replacement: "\\mathbb{Z}", options: "mA" },
  { trigger: "quo", replacement: "\\mathbb{Q}", options: "mA" },
  { trigger: "com", replacement: "\\mathbb{C}", options: "mA" },
  { trigger: "eps", replacement: "\\epsilon", options: "mA" },
  { trigger: "in ", replacement: "\\in", options: "mA" },
  { trigger: "forall", replacement: "\\forall_{$0}\in$1", options: "mA" },
  { trigger: "cap", replacement: "\\cap", options: "mA" },
  {
    trigger: "bcap",
    replacement: "\\bigcap_{${0:n=1}}^{${1:\\infty}} $2",
    options: "mA",
  },
  { trigger: "clean", replacement: "^{*}", options: "mA" },
  { trigger: "cup", replacement: "\\cup", options: "mA" },
  {
    trigger: "bcup",
    replacement: "\\bigcup_{${0:n=1}}^{${1:\\infty}} $2",
    options: "mA",
  },
  { trigger: "nin", replacement: "\\cup", options: "mA" },
  { trigger: "empty", replacement: "\\emptyset", options: "mA" },
  { trigger: "big", replacement: "\\Bigg{{}", options: "mA" },
  ...
  { trigger: "nrt", replacement: "\\sqrt[${0:n}]{$1}", options: "mA" },
  { trigger: "!c=", replacement: "\\cancel{\\subseteq}", options: "mA" },
  { trigger: "app", replacement: "\\approx", options: "mA" },
  { trigger: "^", replacement: "^{$0}", options: "mA" },
  { trigger: "space", replacement: "\\,\\,\\,", options: "mA" },
  { trigger: "|...", replacement: "\\vdots", options: "mA" },
  { trigger: "Var", replacement: "\\operatorname{Var}$0", options: "mA" },
  { trigger: "cov", replacement: "\\operatorname{cov}$0", options: "mA" },
  {
    trigger: "det",
  ...
  {
    trigger: "Amat",
    replacement: "A \\in \\mathbb{F}^{n \\times n} $0",
    options: "mA",
  },

  {
    trigger: "choose",
    replacement: "\\begin{pmatrix} ${0:n} \\\\ ${1:k} \\end{pmatrix}$3",
    options: "mA",
  },
  {
    trigger: "span",
    replacement: "\\operatorname{span}\\{ $0 \\} $1",
    options: "mA",
  },
  { trigger: "uni", replacement: "\\; ^{\\to}_{\\to} \\; ", options: "mA" },
  { trigger: "angle", replacement: "\\langle $0 \\rangle $1", options: "mA" },
  {
    trigger: "rowop",
    replacement: "\\overset{$0}{\\Longrightarrow}",
    options: "mA",
  },
  {
    trigger: "swap",
    replacement: "\\overset{R_{${0:1}} \\; \\iff R_{${1:2}}}{\\Longrightarrow}",
    options: "mA",
  },
  { trigger: "adj", replacement: "\\operatorname{adj} ", options: "mA" },
  ...
  { trigger: "pw", replacement: "^{$0}$1", options: "mA", priority: -1 },
  ...
  { trigger: "wave", replacement: "\\tilde{$0}$1", options: "mA" },
  ...
  {
    trigger: "sum",
    replacement: "\\sum_{${0:n = 0}}^{${1: \\infty}} $2",
    options: "mA",
  },
  ...
  {
    trigger: /([^\\])int/,
    replacement: "[[0]]\\int_{${0:0}}^{${1:1}} $2   \\; d${3:x} $4",
    options: "mA",
  },
  {
    trigger: "int",
    replacement: "\\int^${0:1}_${1:0} $2 \\; d${1:x} $2",
    options: "m",
  },
  {
    trigger: "dint",
  ...
  },
  {
    trigger: "augmat",
    replacement:
      "\\left(\\begin{array} {${0:c c c}|c}\n$1\n\\end{array}\\right)",
    options: "mA",
  },
  {
    trigger: "blockmat",
    replacement: "\\left(\\begin{array} {${0:c c c}}\n$1\n\\end{array}\\right)",
    options: "mA",
  },
  {
    trigger: "blockdet",
  ...
  { trigger: "hline", replacement: "\\hline\n$0", options: "mA" },
  // Brackets
  ...
  { trigger: "mod", replacement: "\\operatorname{mod}", options: "mA" },
  ...
  },
  {
    ...
    options: "mA",
    description: "N x N diagonal matrix",
  },
  ...
  },
  {
    ...
    replacement: (match) => {
      ...
      let output = arr.map((el) => el.join(" & ")).join(" \\\\");
      output = `\\begin{pmatrix}${output}\\end{pmatrix} $1`;
      return output;
    },
    options: "mA",
    description: "N x N scalar matrix",
  },
];
